                ...
                <div class="col-sm-12">
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            ...
                            <?php
                            $all_slider = DB::table('tb1_slider')
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('slider/g7wlRqwmGsDYgsbNTz3Z.jpg')}}" class="girl img-responsive" alt="" />
                                </div>
                            </div>
...
<div class="features_items"><!--features_items-->
    ...
    <h2 class="title text-center">ສີນຄ້າ ມາໃໝ່</h2>
            ...
            <div class="single-products">
                <a href="{{URL::to('/view_product/'.$v_published_product->product_id)}}">
                    ...
                    <img src="{{URL::to($v_published_product->product_image)}}" alt=""  />
                        <h2>{{$v_published_product->product_price}} Kip</h2>
             ...
             <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li><a href="{{URL::to('/view_product/'.$v_published_product->product_id)}}"><i class="fa fa-plus-square"></i>ເບິ່ງສີນຄ້າ</a></li>
               </ul>
            </div>
       </div>
   </div>
